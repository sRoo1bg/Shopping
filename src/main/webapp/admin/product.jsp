        ...
        <c:choose>
                            ...
                            <nav aria-label="..." style="text-align:center;">
                                <ul class="pagination">
                                    <li>
                                        ...
                                        <a href="javascript:ajaxsplit(1)" aria-label="Previous">
                                    ...
                                    <c:forEach begin="1" end="${info.pages}" var="i">
                                        <c:if test="${info.pageNum==i}">
                                            <li>
                                                    <%--<a href="${pageContext.request.contextPath}/prod/ajaxSplit.action?page=${i}" style="background-color: grey">${i}</a>--%>
                                    ...
                                    <li>
                                            <%--<a href="${pageContext.request.contextPath}/prod/split.action?page=${info.prePage}" aria-label="Previous">--%>
                                        <a href="javascript:ajaxsplit(${info.pages})" aria-label="Previous">
            ...
            <c:otherwise>
                <div>
                    ...
                    <h2 style="width:1200px; text-align: center;color: orangered;margin-top: 100px">暂时没有符合条件的商品哦！</h2>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
...
<script type="text/javascript">
    ...
    function deleteBatch() {
        //得到所有复选框的对象,根据长度判断是否有选中的商品
        //获取选中商品的value,进行字符串拼接
        //发送ajax请求
        //取得所有被选中删除商品的pid
            ...
            if (confirm("您确定删除" + cks.length + "条商品吗？")) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        alert(msg);
                        $("#table").load("http://localhost:8080/Shopping/admin/product.jsp #table");
                    }
                })
            }
        }
    ...
    function del(pid,page) {
        ...
        if (confirm("确定删除吗")) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/prod/deleteAjax.action",
    ...
    function one(pid, page) {
        ...
        location.href = "${pageContext.request.contextPath}/prod/showInfo.action"+str;
    }
