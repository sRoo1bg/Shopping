...
<script type="text/javascript">
	function myclose(ispage) {
		window.location="${pageContext.request.contextPath}/prod/splitPage.action?page="+ispage;
		//window.close();
	}
	/*function myclose(ispage) {
		location.href = javascript+":"+ajaxsplit(ispage);
		alert(ispage);
	}*/
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<%--<input type="hidden" value="${info.pageNum}" name="page">--%>
					<table>
						<tr>
